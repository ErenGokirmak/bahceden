...
public class ProducerViewProducerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_producer_view_producer);

        producerRV = (RecyclerView) findViewById(R.id.producerViewProducerProductsRV);
